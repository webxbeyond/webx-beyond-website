...
function SelectTopics() {
  const cards: {
    ...
    { title: 'প্রোগ্রামিং বেসিক', description: 'প্রোগ্রামিংয়ের মূল ধারণা, সিনট্যাক্স, ডাটা স্ট্রাকচার, প্যারাডাইম, বেস্ট প্র্যাকটিস ও ভাষা তুলনা—সব এক জায়গায়। একদম শুরু থেকে অ্যাডভান্সড পর্যন্ত।', icon: 'solar:code-bold-duotone', href: '/programming', badge: { text: 'সম্পূর্ণ', variant: 'progress' } },
    ...
    { title: 'লিনাক্স', description: 'কমান্ড লাইন, সার্ভার, ক্লাস্টার, শেল স্ক্রিপ্টিং ও ওপেন সোর্স—বাংলায় লিনাক্স মাস্টারি, হাতে-কলমে প্র্যাকটিস ও বাস্তব উদাহরণ।', icon: 'ph:linux-logo-duotone', href: '/linux', badge: { text: 'সম্পূর্ণ', variant: 'progress' } },
    ...
    { title: 'মাইক্রোটিক', description: 'রাউটার, নেটওয়ার্কিং, ISP, VPN, ফায়ারওয়াল, অটোমেশন—বাংলায় সম্পূর্ণ মাইক্রোটিক মাস্টারি সিরিজ।', icon: 'solar:wi-fi-router-bold', href: '/mikrotik', badge: { text: 'সম্পূর্ণ', variant: 'progress' } },
    // AI, Data, Performance
  ...
  { title: 'ক্রিপ্টো ওয়ালেট', description: 'ক্রিপ্টোকারেন্সি সংরক্ষণ, লেনদেন, নিরাপত্তা, ও ওয়ালেট ব্যবহারের সম্পূর্ণ বাংলা গাইড।', icon: 'mdi:wallet-outline', href: '/crypto-wallet', badge: { text: 'নতুন', variant: 'progress' } },
