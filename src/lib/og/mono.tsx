...
const font = await fs.readFile('./src/lib/og/TiroBangla-Regular.ttf');
const fontBold = await fs.readFile('./src/lib/og/TiroBangla-Italic.ttf');
...
function generate({ title, description }: GenerateProps) {
  const siteName = 'ওয়েবএক্স বিয়ন্ড';
  ...
  const logo = (
    ...
    <defs>
      ...
      <linearGradient id="linear-gradient-2" x1="2.83" y1="28.1" x2="37.5" y2="28.1" gradientUnits="userSpaceOnUse">
        <stop offset="0" stopColor="#007bff" />
        <stop offset="1" stopColor="#280594" />
      </linearGradient>
    </defs>
