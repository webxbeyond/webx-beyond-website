...
```
১. ultra‑low latency (১ সেকেন্ডের নিচে) দরকার? — WebRTC বা LL‑HLS/DASH ব্যবহার করুন; বেশি জটিলতা
২. VOD‑এ খরচ গুরুত্বপূর্ণ? — জনপ্রিয় কনটেন্ট pre‑transcode করুন, কম ব্যবহৃত কনটেন্ট cold storage‑এ রাখুন
৩. DRM ও device support দরকার? — DRM ecosystem বেছে নিন, CMAF compatibility নিশ্চিত করুন
৪. global scale দরকার? — multi‑region origin + CDN, global object storage/replication ব্যবহার করুন
```
